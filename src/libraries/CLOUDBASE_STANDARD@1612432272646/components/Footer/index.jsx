  ...
  "properties": {
    "id1": {
      ...
      "x-props": {
        ...
        "classNameList": [
          "wa-comp-CLOUDBASE_STANDARD-Footer"
        ]
      },
      "x-index": 1,
      "properties": {
        "id2": {
          ...
          "x-props": {
            ...
            "classNameListBind": {
              "classList": (forItems) => (this.$WEAPPS_COMP.props.data.fixed ? 'fixed' : '')
            },
            "styleBind": {
              "style": (forItems) => ({ backgroundColor: `${this.$WEAPPS_COMP.props.data.bgColor}` })
            }
          },
          "x-index": 1,
          "properties": {
