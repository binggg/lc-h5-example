...
import cloudbaseStandardCheckboxItem from "libraries/CLOUDBASE_STANDARD@1612432272646/components/CheckboxItem";

import cloudbaseStandardCheckbox from "libraries/CLOUDBASE_STANDARD@1612432272646/components/Checkbox";
...
class CompositeCompWrapper extends React.Component {
  ...
  "componentType": "formField"
    ...
    this.virtualFields = Object.assign({}, props.pageVirtualFields || {}, {
      ...
      "CLOUDBASE_STANDARD:CheckboxItem": cloudbaseStandardCheckboxItem,
    
      "CLOUDBASE_STANDARD:Checkbox": cloudbaseStandardCheckbox,
  ...
  "properties": {
    "id1": {
      ...
      "x-props": {
        ...
        "classNameList": [
          "wa-comp-CLOUDBASE_STANDARD-FormCheckbox"
        ]
      },
      "x-index": 0,
      "properties": {
        ...
        "contentSlot": {
          ...
          "properties": {
            "id2": {
              "key": "id2",
              "x-component": "cloudbase_standard:checkbox",
              "x-props": {
                "sourceKey": "CLOUDBASE_STANDARD:Checkbox",
                "data": {
                  "_visible": true
                },
                "dataBinds": {
              ...
              "properties": {
                "contentSlot": {
                  ...
                  "properties": {
                    "id3": {
                      "key": "id3",
                      "x-component": "cloudbase_standard:checkboxitem",
                      "x-props": {
                        "sourceKey": "CLOUDBASE_STANDARD:CheckboxItem",
                        "data": {
                          "desc": "",
                          "disabled": false,
                          "underline": false
  ...
  "id3": {
    ...
    "style": {},
    "classList": [],
    "widgetType": "CLOUDBASE_STANDARD:CheckboxItem",
    "_parentId": "id2"
  },
  "id2": {
    "_visible": true,
    "style": {},
    "classList": [],
    "widgetType": "CLOUDBASE_STANDARD:Checkbox",
    "_parentId": "id1"
  },
  "id1": {
    "rules": [],
