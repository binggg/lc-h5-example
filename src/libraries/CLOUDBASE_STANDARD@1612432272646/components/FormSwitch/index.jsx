...
import cloudbaseStandardSwitch from "libraries/CLOUDBASE_STANDARD@1612432272646/components/Switch";
...
class CompositeCompWrapper extends React.Component {
  ...
  "componentType": "formField"
    ...
    this.virtualFields = Object.assign({}, props.pageVirtualFields || {}, {
      ...
      "CLOUDBASE_STANDARD:Switch": cloudbaseStandardSwitch,
    
      "CLOUDBASE_STANDARD:FormItem": cloudbaseStandardFormItem,
    
    });
    this.events = (["change","validator"]).reduce((obj, trigger) => {
      obj[trigger] = (event) => {
  ...
  "properties": {
    "id1": {
      ...
      "x-props": {
        ...
        "classNameList": [
          "wa-comp-CLOUDBASE_STANDARD-FormSwitch"
        ]
      },
      "x-index": 0,
      "properties": {
        ...
        "contentSlot": {
          ...
          "properties": {
            "id9": {
              "key": "id9",
              "x-component": "cloudbase_standard:switch",
              "x-props": {
                "sourceKey": "CLOUDBASE_STANDARD:Switch",
                "data": {
                  "_visible": true
                },
                "dataBinds": {
                  ...
                  "checkedIcon": () => this.$WEAPPS_COMP.props.data.checkedIcon,
                  "uncheckedIcon": () => this.$WEAPPS_COMP.props.data.uncheckedIcon
                },
                "dataTypes": [
                  {
                    "propertyPath": "type",
                  ...
                  {
                    "propertyPath": "checkedIcon",
                    "type": "bind"
                  },
                  {
                    "propertyPath": "uncheckedIcon",
                    "type": "bind"
                  }
                ],
                "listenerInstances": [
                  {
                    "trigger": "change",
                    "instanceFunction": function({ event, forItems }) {    const wid = this.widgets.id9;    const widgetData = (forItems.forIndexes && forItems.forIndexes.length > 0) ? get(wid, forItems.forIndexes) : wid;    widgetData.value = event.detail.value;  }.bind(this)
                  },
                  {
                    "key": "",
                    "trigger": "change",
  ...
  "id9": {
    ...
    "style": {},
    "classList": [],
    "widgetType": "CLOUDBASE_STANDARD:Switch",
    "_parentId": "id1"
  },
  "id1": {
    "rules": [],
