  ...
  "properties": {
    "id1": {
      ...
      "x-props": {
        ...
        "classNameList": [
          "wa-comp-CLOUDBASE_STANDARD-StatusTip"
        ]
      },
      "x-index": 1,
      "properties": {
        "id2": {
          ...
          "x-props": {
            ...
            "classNameListBind": {
              "classList": (forItems) => (this.$WEAPPS_COMP.props.data.type === 'loading'? 'lcap-loading':'')
            }
          },
          "x-index": 1,
          "properties": {
              ...
              "properties": {
                "id8": {
                  ...
                  "x-props": {
                    ...
                    "dataBinds": {
                      ...
                      "_visible": () => this.$WEAPPS_COMP.props.data.text
                    },
                    "dataTypes": [
                      {
                        "propertyPath": "text",
                ...
                "id9": {
                  ...
                  "x-props": {
                    ...
                    "dataBinds": {
                      "_visible": (forItems) => (!this.$WEAPPS_COMP.props.data.text)
                    },
                    "dataTypes": [
                      {
                        "propertyPath": "name",
