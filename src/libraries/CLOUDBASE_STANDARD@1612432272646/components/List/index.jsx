  ...
  "properties": {
    "id1": {
      ...
      "x-props": {
        ...
        "classNameList": [
          "lcap-list",
          "wa-comp-CLOUDBASE_STANDARD-List"
        ]
      },
      "x-index": 1,
      "properties": {
        ...
        "id3": {
          ...
          "x-props": {
            ...
            "classNameListBind": {
              "classList": (forItems) => (this.$WEAPPS_COMP.props.data.bordered && this.$WEAPPS_COMP.props.data.borderPosition? `lcap-hairline--${this.$WEAPPS_COMP.props.data.borderPosition}`:'')
            }
          },
          "x-index": 2,
          "properties": {
