...
import handler$onBlur from "./lowcode/handler/onBlur.js";

import handler$onFocus from "./lowcode/handler/onFocus.js";

import handler$onConfirm from "./lowcode/handler/onConfirm.js";
...
class CompositeCompWrapper extends React.Component {
  ...
  "componentType": "formField"
    ...
    this.events = (["change","focus","blur","confirm","clear","validator"]).reduce((obj, trigger) => {
      obj[trigger] = (event) => {
    ...
    this.handler = this.$WEAPPS_COMP.handler = {
      ...
      onBlur: handler$onBlur.bind(this),
      
      onFocus: handler$onFocus.bind(this),
      
      onConfirm: handler$onConfirm.bind(this),
  ...
  "properties": {
    "id8": {
      ...
      "x-props": {
        ...
        "classNameList": [
          "wa-comp-CLOUDBASE_STANDARD-FormInput"
        ]
      },
      "x-index": 0,
      "properties": {
            ...
            "id14": {
              ...
              "x-props": {
                ...
                "listenerInstances": [
                  {
                    "trigger": "change",
                    "instanceFunction": function({ event, forItems }) {    const wid = this.widgets.id14;    const widgetData = (forItems.forIndexes && forItems.forIndexes.length > 0) ? get(wid, forItems.forIndexes) : wid;    widgetData.value = event.detail.value;  }.bind(this)
                  },
                  {
                    "key": "",
                    "trigger": "change",
                  ...
                  },
                  {
                    "key": "",
                    "trigger": "focus",
                    "instanceFunction": this.handler.onFocus.bind(this),
                    "data": {
                      "target": ""
                    }
                  },
                  {
                    "key": "",
                    "trigger": "blur",
                    "instanceFunction": this.handler.onBlur.bind(this),
                    "data": {
                      "target": ""
                    }
                  },
                  {
                    "key": "",
                    "trigger": "confirm",
                    "instanceFunction": this.handler.onConfirm.bind(this),
                    "data": {
                      "target": ""
                    }
                  },
