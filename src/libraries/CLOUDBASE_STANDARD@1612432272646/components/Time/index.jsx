...
import gsdH5ReactTimePicker from "libraries/gsd-h5-react@0.0.61/components/TimePicker";
...
class CompositeCompWrapper extends React.Component {
  ...
  "componentType": "formControl"
    ...
    this.virtualFields = Object.assign({}, props.pageVirtualFields || {}, {
      ...
      "gsd-h5-react:TimePicker": gsdH5ReactTimePicker,
  ...
  "properties": {
    "id1": {
      "key": "id1",
      "x-component": "gsd-h5-react:timepicker",
      "x-props": {
        "sourceKey": "gsd-h5-react:TimePicker",
        "data": {
          "mode": "time",
          "name": "thisIsTimeKey",
          "autoFill": "",
        ...
        "classNameList": [
          "wa-comp-CLOUDBASE_STANDARD-Time"
        ]
      },
      "x-index": 0,
      "properties": {
  ...
  "id1": {
    ...
    "style": {},
    "classList": [],
    "widgetType": "gsd-h5-react:TimePicker"
  }
}
    const dataBinds = {
  "id3": {
